...
Status RsaHashedAlgorithm::ImportKey(blink::WebCryptoKeyFormat format,
  ...
  switch (format) {
    ...
    case blink::kWebCryptoKeyFormatTPM:
      return TPMImport(format, key_data, algorithm, extractable, usages, key); // TPM
    default:
...
Status RsaHashedAlgorithm::ExportKey(blink::WebCryptoKeyFormat format,
  ...
  switch (format) {
    ...
    case blink::kWebCryptoKeyFormatTPM:
      return TPMExport(format, key, buffer); // TPM
    default:
