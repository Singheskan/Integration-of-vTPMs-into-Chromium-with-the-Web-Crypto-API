...
#include "components/webcrypto/algorithm_dispatch.h" // cb
...
const EVP_MD* GetDigestTest(const blink::WebCryptoAlgorithm& hash_algorithm);

// Returns the EVP_MD that corresponds with |id|, or nullptr on failure.
const EVP_MD* GetDigest(blink::WebCryptoAlgorithmId id);
const EVP_MD* GetDigestTest(blink::WebCryptoAlgorithmId id);
